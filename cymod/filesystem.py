...
Tools for finding Cypher files in the file system and extracting their
contained data.
...
class CypherFile(object):
    ...
    Attributes:
        ...
        _cached_data (dict): Data cache used to avoid the need to re-read each
            time we use a CypherFile object to access data. Stores a dict of
            the structure {'params':<dict>, 'queries':<list of strings>}.
